...
7. Reply with a short summary of what you produced and any information you'd need from the CEO to make it more specific (e.g. target customer, pricing, differentiators).`,
  tools: [
    docTool("sales"),
